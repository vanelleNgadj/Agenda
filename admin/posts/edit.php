        ...
        <?php include(ROOT_PATH . "/app/includes/adminSidebar.php"); ?>
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="index.php" class="btn btn-big">Gérer les évenements</a>
                </div>


                <div class="content">

                    <h2 class="page-title">Editer un évenement</h2>
                    ...
                    <form action="edit.php" method="post" enctype="multipart/form-data">
                      ...
                      <!--  <div>
                           proposition de pays
                            <label>Pays</label>
                            <select name="pays" class="text-input">
                        ...
                        <div>
                            <button type="submit" name="update-post" class="btn btn-big">Modifier l'évenement</button>
                        </div>
                    </form>
